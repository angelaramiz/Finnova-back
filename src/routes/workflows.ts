...
const accountingTypes = ['invoice_emission', 'payment_registration', 'tax_calculation', 'bank_reconciliation', 'journal_entry', 'payroll', 'supplier_invoice', 'business_expense', 'payment_scheduling', 'ap_reconciliation', 'cfdi_reception', 'credit_note', 'cash_cut', 'depreciation', 'financial_statements', 'conciliacion_practica', 'auditoria_practica', 'nomina_practica', 'reporte_practica', 'poliza_practica'];

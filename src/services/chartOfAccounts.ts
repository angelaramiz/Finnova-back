...
const SEED: Account[] = [
  // ACTIVO
  { code: '1', name: 'ACTIVO', type: 'Activo', level: 1, nature: 'D', balance: 502500, isDetail: false },
  ...
  { code: '1-08', name: 'Edificios', type: 'Activo', parentCode: '1', level: 2, nature: 'D', balance: 1200000, isDetail: true },
  { code: '1-09', name: 'Maquinaria y equipo', type: 'Activo', parentCode: '1', level: 2, nature: 'D', balance: 380000, isDetail: true },
  ...
  // PASIVO
  { code: '2', name: 'PASIVO', type: 'Pasivo', level: 1, nature: 'H', balance: 485000, isDetail: false },
  ...
  // INGRESO
  { code: '4', name: 'INGRESOS', type: 'Ingreso', level: 1, nature: 'H', balance: 1250000, isDetail: false },
  { code: '4-01', name: 'Ventas', type: 'Ingreso', parentCode: '4', level: 2, nature: 'H', balance: 980000, isDetail: true },
  { code: '4-02', name: 'Servicios', type: 'Ingreso', parentCode: '4', level: 2, nature: 'H', balance: 180000, isDetail: true },
  { code: '4-03', name: 'Otros ingresos', type: 'Ingreso', parentCode: '4', level: 2, nature: 'H', balance: 90000, isDetail: true },

  // GASTO
  { code: '5', name: 'GASTOS', type: 'Gasto', level: 1, nature: 'D', balance: 1155500, isDetail: false },
